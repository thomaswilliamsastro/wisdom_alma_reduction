...
LIST=("
https://almascience.eso.org/dataPortal/2012.1.01092.S_uid___A002_X835491_X11f4.asdm.sdm.tar
https://almascience.eso.org/dataPortal/member.uid___A002_X6f9b0f_X249.README.txt.tar
https://almascience.eso.org/dataPortal/2012.1.01092.S_uid___A002_X6f9b0f_X249_auxiliary.tar
")
...
echo "Downloading the following files in up to 5 parallel streams. Total size is 1012.9MB."
echo "${LIST}"
