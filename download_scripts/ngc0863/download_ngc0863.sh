...
LIST=("
https://almascience.eso.org/dataPortal/2016.2.00046.S_uid___A001_X124a_X1f7_auxiliary.tar
https://almascience.eso.org/dataPortal/2016.2.00046.S_uid___A002_Xc2de5d_X2634.asdm.sdm.tar
https://almascience.eso.org/dataPortal/member.uid___A001_X124a_X1f7.README.txt.tar
")
...
echo "Downloading the following files in up to 5 parallel streams. Total size is 604.0MB."
echo "${LIST}"
