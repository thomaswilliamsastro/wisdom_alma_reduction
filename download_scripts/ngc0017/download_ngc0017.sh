...
LIST=("
https://almascience.nrao.edu/dataPortal/member.uid___A001_X124a_X1f3.README.txt.tar
https://almascience.nrao.edu/dataPortal/2016.2.00046.S_uid___A001_X124a_X1f3_auxiliary.tar
https://almascience.nrao.edu/dataPortal/2016.2.00046.S_uid___A002_Xc2bb44_X1398.asdm.sdm.tar
")
...
echo "Downloading the following files in up to 5 parallel streams. Total size is 729.8MB."
echo "${LIST}"
