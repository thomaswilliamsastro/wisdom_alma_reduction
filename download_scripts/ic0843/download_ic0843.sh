...
LIST=("
https://almascience.nrao.edu/dataPortal/member.uid___A001_X124a_X223.README.txt.tar
https://almascience.nrao.edu/dataPortal/2016.2.00046.S_uid___A002_Xc3a8fe_Xe5.asdm.sdm.tar
https://almascience.nrao.edu/dataPortal/2016.2.00046.S_uid___A001_X124a_X223_auxiliary.tar
")
...
echo "Downloading the following files in up to 5 parallel streams. Total size is 1.0GB."
echo "${LIST}"
