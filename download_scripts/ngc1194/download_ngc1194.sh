...
LIST=("
https://almascience.eso.org/dataPortal/2016.1.01553.S_uid___A002_Xb9c01c_X1931.asdm.sdm.tar
https://almascience.eso.org/dataPortal/2016.1.01553.S_uid___A001_X87d_X5c7_auxiliary.tar
https://almascience.eso.org/dataPortal/member.uid___A001_X87d_X5c7.README.txt.tar
")
...
echo "Downloading the following files in up to 5 parallel streams. Total size is 20.1GB."
echo "${LIST}"
