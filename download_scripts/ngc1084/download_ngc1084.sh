...
LIST=("
https://almascience.eso.org/dataPortal/member.uid___A001_X124a_X1fb.README.txt.tar
https://almascience.eso.org/dataPortal/2016.2.00046.S_uid___A001_X124a_X1fb_auxiliary.tar
https://almascience.eso.org/dataPortal/2016.2.00046.S_uid___A002_Xc2d675_Xd7d.asdm.sdm.tar
")
...
echo "Downloading the following files in up to 5 parallel streams. Total size is 702.2MB."
echo "${LIST}"
